...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__services_shared_service__ = __webpack_require__("./src/app/services/shared.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__app_routing__ = __webpack_require__("./src/app/app.routing.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["J" /* NgModule */])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_26__app_routing__["a" /* Routing */]
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_21__services_user_service_client__["a" /* UserService */], __WEBPACK_IMPORTED_MODULE_22__services_website_service_client__["a" /* WebsiteService */], __WEBPACK_IMPORTED_MODULE_23__services_page_service_client__["a" /* PageService */], __WEBPACK_IMPORTED_MODULE_24__services_widget_service_client__["a" /* WidgetService */], __WEBPACK_IMPORTED_MODULE_25__services_shared_service__["a" /* SharedService */], { provide: __WEBPACK_IMPORTED_MODULE_4__angular_common__["g" /* LocationStrategy */], useClass: __WEBPACK_IMPORTED_MODULE_4__angular_common__["d" /* HashLocationStrategy */] }],
...
var APP_ROUTES = [
    ...
    { path: 'user/:userId/website/:websiteId/page/:pageId/widget/:widgetId/heading', component: __WEBPACK_IMPORTED_MODULE_12__components_widget_widget_edit_widget_header_widget_header_component__["a" /* WidgetHeaderComponent */] },
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Component */])({ selector: 'app-login', template: __webpack_require__("./src/app/components/user/login/login.component.html"), styles: [__webpack_require__("./src/app/components/user/login/login.component.css")] }),
...
var ProfileComponent = /** @class */ (function () {
    function ProfileComponent(userService, activateRoute, router, sharedService) {
        this.userService = userService;
        this.activateRoute = activateRoute;
        this.router = router;
        this.sharedService = sharedService;
    ...
    ProfileComponent.prototype.ngOnInit = function () {
        ...
        this
            ...
            _this.userId = params['userId'];
            console.log("profile ts 38: userid=", _this.userId);
        });
        this
            .userService
            ...
            console.log("profile ts 48: user=", _this.user);
        });
    };
    ...
    ProfileComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Component */])({ selector: 'app-profile', template: __webpack_require__("./src/app/components/user/profile/profile.component.html"), styles: [__webpack_require__("./src/app/components/user/profile/profile.component.css")] }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__services_user_service_client__["a" /* UserService */], __WEBPACK_IMPORTED_MODULE_3__angular_router__["a" /* ActivatedRoute */], __WEBPACK_IMPORTED_MODULE_3__angular_router__["b" /* Router */], __WEBPACK_IMPORTED_MODULE_4__services_shared_service__["a" /* SharedService */]])
    ], ProfileComponent);
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Component */])({ selector: 'app-register', template: __webpack_require__("./src/app/components/user/register/register.component.html"), styles: [__webpack_require__("./src/app/components/user/register/register.component.css")] }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__services_user_service_client__["a" /* UserService */], __WEBPACK_IMPORTED_MODULE_3__angular_router__["b" /* Router */], __WEBPACK_IMPORTED_MODULE_4__services_shared_service__["a" /* SharedService */]])
    ], RegisterComponent);
...
var WidgetChooserComponent = /** @class */ (function () {
    function WidgetChooserComponent(widgetService, activateRoute, router) {
        this.widgetService = widgetService;
        this.activateRoute = activateRoute;
        this.router = router;
        this.types = ['HEADING', 'IMAGE', 'YOUTUBE'];
        this.type_urls = ['heading', 'image', 'youtube'];
    }
    ...
    ;
    WidgetChooserComponent.prototype.newWidget = function (idx) {
        var _this = this;
        var newWidget = { type: this.types[idx] };
        this.widgetService.createWidget(this.pageId, newWidget)
            .subscribe(function (data) {
            _this.router.navigate([
                '/user', _this.userId, 'website', _this.websiteId, 'page',
                _this.pageId, 'widget', data._id, _this.type_urls[idx]
            ]);
        }, function (error) {
...
var WidgetHeaderComponent = /** @class */ (function () {
    ...
    WidgetHeaderComponent.prototype.update = function () {
        ...
        }, function (error) { console.log('widget update error'); });
    };
    WidgetHeaderComponent.prototype.delete = function () {
        ...
        this.widgetService.deleteWidget(this.widgetId).subscribe(function (data) {
            ...
            _this.router.navigate([
                '/user', _this.userId, 'website', _this.websiteId, 'page', _this.pageId,
                'widget'
            ]);
        }, function (error) { console.log('widget delete error'); });
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_10" /* ViewChild */])('f'),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1__angular_forms__["b" /* NgForm */])
    ...
    WidgetHeaderComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__services_widget_service_client__["a" /* WidgetService */], __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* Router */],
...
var WidgetListComponent = /** @class */ (function () {
        ...
        this.widgetService.findWidgetsByPageId(this.pageId)
            ...
            for (var i = 0; i < _this.widgets.length; i++) {
                if (_this.widgets[i]['url']) {
                    _this.widgets[i]['url'] =
                        _this.sanitizer.bypassSecurityTrustResourceUrl(_this.widgets[i]['url']);
                }
            }
        });
    };
    ;
    WidgetListComponent.prototype.reorder = function (pageId, widgetId) {
        var _this = this;
        this.widgetService.reorder(pageId, widgetId).subscribe(function (data) {
    ...
    WidgetListComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__services_widget_service_client__["a" /* WidgetService */],
            __WEBPACK_IMPORTED_MODULE_2__angular_router__["a" /* ActivatedRoute */], __WEBPACK_IMPORTED_MODULE_1__angular_platform_browser__["b" /* DomSanitizer */]])
    ], WidgetListComponent);
...
var WidgetService = /** @class */ (function () {
    ...
    WidgetService.prototype.findWidgetById = function (widgetId) {
        return this._http.get('api/widget/' + widgetId).map(function (res) {
            var data = res.json();
            return data;
        });
    };
    ...
    ;
    WidgetService.prototype.reorder = function (pageId, widgetId) {
        return this._http
